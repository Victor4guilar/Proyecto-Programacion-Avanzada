...
class MetodosNumericosApp:
    ...
    def metodo_busqueda_incrementos(self, expr, xi, xf, incremento):
        ...
        while x <= xf:
            ...
            fx_sig = self.evaluar_funcion(expr, x_sig)

            ejex.append(x)
            ejey.append(fx)

            if fx * fx_sig < 0:
                intervalos.append((x, x_sig))
    ...
    def cargar_metodo(self):
        ...
        #Campo común
        if metodo != "Mínimos Cuadrados Lineales":
        ...
        #ERROR
        if metodo not in ["Búsqueda por Incrementos", "Mínimos Cuadrados Lineales"]:
            ...
            if metodo == "Búsqueda por Incrementos":
                ...
                if intervalos:
                    ...
                    for i, intervalo in enumerate(intervalos, start=1):
                        ...
                        texto += (
                            f"Raíz {i}: "
                            f"[{intervalo[0]:.6f}, {intervalo[1]:.6f}]\n"
                        )
