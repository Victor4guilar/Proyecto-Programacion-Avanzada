...
class MetodosNumericosApp:
    ...
    def crear_layout(self):
        ...
        self.combo_metodos['values'] = ["Bisección", "Falsa Posición"]  # Se añade Falsa Posición como opción disponible
    ...
    def cargar_metodo(self):
        ...
        if self.metodo_var.get() in ["Bisección", "Falsa Posición"]:  # Permite usar mismos inputs para ambos métodos
